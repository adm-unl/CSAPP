...
{
    return ((icode) == (I_IADDQ) || (icode) == (I_NOP) || (icode) == 
      (I_HALT) || (icode) == (I_RRMOVQ) || (icode) == (I_IRMOVQ) || (icode)
       == (I_RMMOVQ) || (icode) == (I_MRMOVQ) || (icode) == (I_ALU) || 
...
{
    return ((icode) == (I_IADDQ) || (icode) == (I_RRMOVQ) || (icode) == 
...
long long gen_dstE()
{
    return ((((icode) == (I_RRMOVQ)) & (cond)) ? (rb) : ((icode) == 
        (I_IADDQ) || (icode) == (I_IRMOVQ) || (icode) == (I_ALU)) ? (rb) : 
